# -*- coding: utf-8 -*-
"""
Created on Sun Feb 18 08:12:44 2018
...
_, H, W = img.shape
img = resize_with_random_interpolation(img, (m_size, m_size))
bbox = resize_bbox(bbox, (H, W), (m_size, m_size))
